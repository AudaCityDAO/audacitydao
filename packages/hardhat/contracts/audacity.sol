...
contract ERWA is ERC1155, AccessControl {
    ...
    function updateMin(uint256 id, uint256 minTokens)
        public
    ...
    function updateMax(uint256 id, uint256 maxTokens)
        public
        onlyRole(MINTER_ROLE)
    {
    ...
    function updateUsdPricePerToken(uint256 id, uint256 usdPricePerToken)
        public
        onlyRole(MINTER_ROLE)
    {
    ...
    function updateStartDate(uint256 id, uint256 startDate)
        public
        onlyRole(MINTER_ROLE)
    {
    ...
    function updateEndDate(uint256 id, uint256 endDate)
        public
        onlyRole(MINTER_ROLE)
    {
    ...
    function withdrawFunds(address _receiver)
        public
