  ...
  return (
    <div className="mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        <DetailsCard title="12" type="Properties" text="Number of Properties" />
        <DetailsCard title="4" type="rooms" text="Number of Rooms" />
        <DetailsCard title="5,500" type="sq ft" text="Area" />
        <DetailsCard title="28" type="months" text="Project Duration" />
        <DetailsCard title="Duplex" type="" text="structure" />
        <DetailsCard title="3" type="cars parking" text="Parking" />
        <DetailsCard title="5" type="baths" text="Bath/toilet" />
